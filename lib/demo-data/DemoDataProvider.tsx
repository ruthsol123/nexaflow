...
import { activity as initialActivity, Activity, employees as initialEmployees, Employee, notifications as initialNotifications, Notification, projects as initialProjects, Project, tasks as initialTasks, Task, teams as initialTeams, Team, ChecklistItem } from "@/lib/demo-data/workspace";
...
export function DemoDataProvider({ children }: { children: ReactNode }) {
  ...
  return <DemoDataContext.Provider value={{ employees: employeeState, projects: projectState, tasks: taskState, teams: teamState, notifications: notificationState, activity: initialActivity, createEmployee, createProject, updateProject, deleteProject, createTask, updateTask, deleteTask, updateChecklistItem, createTeam, updateTeam, deleteTeam, markNotificationRead, markAllNotificationsRead }}>{children}</DemoDataContext.Provider>;
}
