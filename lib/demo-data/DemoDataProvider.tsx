...
export function DemoDataProvider({ children }: { children: ReactNode }) {
  ...
  function createEmployee(employee: Omit<Employee, "id">, password: string) { const created = { ...employee, id: makeId("employee") }; setEmployeeState((items) => { const next = [...items, created]; persist("nexaflow-employees", next); return next; }); saveDemoAccount({ email: created.email, password, role: "employee", accountType: "employee", displayName: created.name }); return created; }
