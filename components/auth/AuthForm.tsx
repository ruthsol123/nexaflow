...
function validateField(field: FieldName, value: string, values: FormValues, isSignup: boolean, accountType: AccountType | null): string | undefined {
  ...
  if (field === "password") {
    ...
    if (isSignup && (value.length < 12 || !/[A-Z]/.test(value) || !/[a-z]/.test(value) || !/[0-9]/.test(value) || !/[^A-Za-z0-9]/.test(value))) return "Use 12+ characters with uppercase, lowercase, number, and special character.";
  }
