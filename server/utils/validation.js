...
const password = (field = "password") => require("express-validator").body(field).isString().matches(passwordRules).withMessage("Password must be at least 12 characters and include uppercase, lowercase, number, and special character.");
